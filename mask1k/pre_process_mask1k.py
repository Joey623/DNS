...
parser.add_argument('--dataset', type=str, default='mask1k',
                    help='dataset name: mask1k (short for Market-Sketch-1K) or pku (short for PKU-Sketch)')
parser.add_argument('--data_path', type=str, default='/data3/lkj/rebuttal_sketchreid/dataset/market-mix-cross',
                    help='path to dataset, and where you store attributes')
...
parser.add_argument('--train_style', type=str, default='ABCDEF',
                    help='styles: any combination of A-F. For example: B, EF, ACEF...')
...
data_path = '../Dataset/Market-Sketch-1K'
